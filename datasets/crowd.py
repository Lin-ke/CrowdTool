...
class Crowd(data.Dataset):
    def __init__(self, root_path, crop_size=256,
        ...
        self.gt_list = sorted(glob(os.path.join(self.root_path, '*.npy')))  # change to npy for gt_list #/home/home/wangchenhao/code/dataset/RGBTCrowdCounting/RGBT_process/test/3667_GT.npy
        
        #self.gt_list = ['/home/home/wangchenhao/code/dataset/RGBTCrowdCounting/RGBT_process/test/1226_GT.npy'] #1226_RGB 1264_RGB 1567_RGB 1371 1510_RGB 1349_RGB  1760_RGB 1226
    ...
    def __getitem__(self, item):
        ...
        #print ('000000000000000000000000',gt_path)
